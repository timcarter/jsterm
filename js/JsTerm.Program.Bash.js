	...
	builder:function (_superclass) {
		...
		_classPrototype.execute = function () {
			...
			*/
			...
			if (_this.isWired) {
				var
					_workingDir = _this._filesystem.get ('workingDirectory').get ('name')
				;
		...
		_classPrototype.updateUi = function () {
			...
			if (_this.isWired) {
				var _container = _this.getNode('container');

				_container.innerHTML.trim() &&
					Uize.Node.injectHtml (
						_container,
						'<br/>',
						'inner bottom'
